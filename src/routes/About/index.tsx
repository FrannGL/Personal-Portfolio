						...
						<div className={styles.content}>
							...
							<Fade direction='up' triggerOnce={true}>
								<div className={styles.leyends}>
									...
									{isWideScreen && <p className={styles.leyend}>{dict("about.description02")}</p>}
								</div>
							</Fade>
						</div>
					</Fade>
					<Fade delay={700} cascade damping={0.6} triggerOnce={true}>
						<ul className={styles.resume}>
							<li className={styles.item}>
								{dict("about.list01")}:<span className={styles.content}>Franco Galluccio</span>
							</li>
							<li className={styles.item}>
								{dict("about.list02")}:<span className={styles.content}>28</span>
							</li>
							<li className={styles.item}>
								{dict("about.list03")}:<span className={styles.content}>+54 9 11-2155-7802</span>
							</li>
							<li className={styles.item}>
								{dict("about.list04")}:<span className={styles.content}>Buenos Aires, Argentina</span>
							</li>
							<li className={styles.item}>
								{dict("about.list05")}:<span className={styles.content}>franngl.vercel.app</span>
							</li>
							<li className={styles.item}>
								{dict("about.list06")}:<span className={styles.content}>francoivangalluccio@gmail.com</span>
							</li>
						</ul>
					</Fade>
